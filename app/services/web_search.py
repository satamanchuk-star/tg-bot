...
# Только явные интернет-интенты. Гео-локальные триггеры (адрес, телефон,
# расписание, маршрут, «когда откроется») убраны намеренно: такие вопросы
# про объекты ЖК должны отвечаться из базы знаний или честным «не знаю» —
# сниппет из выдачи про другой город хуже, чем отсутствие ответа.
