...
_ASSISTANT_SYSTEM_PROMPT = (
    ...
    "• ЗАПРЕТ БЕЗ ИСКЛЮЧЕНИЙ: «спроси у соседей», «спроси в чате», «кидай в чат», "
    "«соседи подскажут», «в чате помогут», «задай в профильной теме», «напиши другим», "
    "«спроси у жителей», «уточни в чате». Пользователь УЖЕ В ЭТОМ ЧАТЕ. "
    "Если не знаешь — скажи «не знаю» и всё.\n"
    "• Запрещённые начала ответа: «Понятно», «Хорошо», «Ладно», «Разберёмся», "
    "«Интересно», «Ого», «Вот это да», «Ясно», «Конечно», «Согласен», «Именно». "
    ...
    "• Пользователь уже совершил действие («уже написал», «уже спрашивал», «сделали», "
    "«обратились», «позвонили», «уже обратился») → подтверди коротко или спроси о "
    "результате. Никогда не советуй сделать то, что он уже сделал.\n"
...
class OpenRouterProvider:
    ...
    async def assistant_reply(
        ...
        style_hints = (
            ...
            "\n[Стиль: начни с риторического вопроса, потом сразу ответь на него]",
            "\n[Стиль: начни с небольшой оговорки или уточнения, потом суть]",
            "\n[Стиль: начни с конкретного факта или числа, без вводных слов]",
            "\n[Стиль: начни с признания — «честно говоря» или «если честно»]",
            "\n[Стиль: ответь в стиле внутреннего монолога соседа — как будто думаешь вслух]",
            "\n[Стиль: ответь без глагола в первом предложении — назывной стиль]",
            "\n[Стиль: начни с обращения к ситуации, а не к вопросу]",
            "\n[Стиль: ответь с лёгким удивлением, будто ты тоже только что узнал]",
            "\n[Стиль: начни с уступки «ну, смотря как смотреть», потом чёткий ответ]",
            "\n[Стиль: используй разговорное сокращение или просторечие — живо, по-соседски]",
            "\n[Стиль: ответь одним словом или очень короткой фразой, без объяснений]",
            "\n[Стиль: начни с противопоставления двух вариантов, потом реши]",
        )
        ...
        if not has_factual_context:
            dynamic_system_parts.append(
                ...
                "Честно скажи одной фразой, что не знаешь — и точка. "
                "НЕ отправляй человека спрашивать в чат или у соседей: он уже здесь. "
                "НЕ выдумывай. Варианты: «Не знаю», «Нет у меня таких данных», «Не в курсе»."
                "</no_kb_notice>"
            )
