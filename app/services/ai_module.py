...
_PLACES_SYNONYMS: dict[str, list[str]] = {
    ...
    # Бытовые услуги и частые бытовые формулировки (аудит-3, июль 2026)
    "химчистк": ["химчистк", "прачечн"],
    "прачечн": ["прачечн", "химчистк", "стирк"],
    "постирать": ["прачечн", "химчистк"],
    "ателье": ["ателье", "ремонт одежды", "швейн"],
    "подшить": ["ателье", "ремонт одежды"],
    "ушить": ["ателье", "ремонт одежды"],
    "ключ": ["ключ", "мастерск"],
    "обув": ["обув", "мастерск", "ремонт обуви"],
    "набойк": ["ремонт обуви", "мастерск"],
    "починить": ["ремонт", "мастерск"],
    "мастерск": ["мастерск", "ремонт"],
    "такси": ["такси", "трансфер"],
    "анализ": ["анализ", "лаборатор", "медицин"],
    "лаборатор": ["лаборатор", "анализ"],
    "инвитро": ["инвитро", "лаборатор", "анализ"],
    "гемотест": ["гемотест", "лаборатор", "анализ"],
    "нотариус": ["нотариус", "юрист"],
    "юрист": ["юрист", "нотариус"],
    "цветы": ["цвет", "букет"],
    "букет": ["цвет", "букет"],
    "окн": ["окн", "остеклен"],
    "клинер": ["клининг", "уборк"],
    "клининг": ["клининг", "уборк"],
    "уборщиц": ["клининг", "уборк"],
    "телефон почин": ["ремонт техники", "ремонт телефон"],
    "сантехник": ["сантехник", "аварийн"],
    "электрик": ["электрик", "аварийн"],
}
