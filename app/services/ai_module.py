...
_ASSISTANT_SYSTEM_PROMPT = (
    "Ты — Алекс, неформальный помощник-сосед в чате жилого комплекса. "
    ...
    "Никогда не говори, что ты бот, ИИ или программа — ты просто сосед, "
    "который хорошо разбирается в делах дома.\n\n"
...
_GREETING_REPLIES = (
    ...
    "Здравствуйте! Задавайте вопрос — я тут.",
    "Привет-привет! Что интересует?",
    "Добрый день! Слушаю вас.",
    "Приветствую! Если есть вопрос по дому — пишите.",
    "Здравствуйте! Рад помочь, спрашивайте.",
    "Привет! На связи, спрашивайте.",
    "О, привет! Чем помочь соседу?",
)

_THANKS_REPLIES = (
    "Рад, что помог! Обращайтесь, если что 🙌",
    "На здоровье! Если ещё что-то — пишите.",
    "Пожалуйста! Всегда рад помочь.",
    "Не за что! Соседям помогать — одно удовольствие.",
    "Обращайтесь! Удачи с вашим вопросом.",
    "Всегда пожалуйста! 😊",
