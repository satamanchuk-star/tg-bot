...
MENTION_REPLIES = [
    ...
    "Провожу инвентаризацию хорошего настроения. Пока в плюсе!",
    ...
    "Проверяю прогноз погоды. Если дождь — готовьте зонтики и хорошее настроение.",
    "Пытаюсь разгадать, кто паркуется на двух местах сразу. Пока безуспешно.",
    "Перечитываю правила на случай, если кто-то решит их нарушить. Готов!",
    ...
    "Наблюдаю за чатом с мудростью домового и скоростью модератора.",
