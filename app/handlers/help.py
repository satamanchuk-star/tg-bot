...
HELP_MENU_TEXT = (
    ...
    "<b>Улучшения и монеты</b>\n"
    "• /магазин — потратить монеты (голосования и другие плюшки)\n"
...
═══ УЛУЧШЕНИЯ И МОНЕТЫ ═══
• /доработка — предложить улучшение бота (50 монет, раз в месяц).
• /доработки — список предложений, голосование (10 монет за голос).
• /магазин — потратить монеты (голосования и другие плюшки).
...
Обязательно объясни, КАК меня позвать (Жабот/жаб/бот или реплай).
Можно пошутить про шлагбаум — это классика. Не перечисляй всё подряд —
расставь акценты под стиль, который тебе дали.
"""
