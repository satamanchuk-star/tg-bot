...
HELP_MENU_TEXT = (
    ...
    "• Сам подскажу, если вижу, что могу помочь\n\n"
    "<b>Информация о ЖК</b>\n"
    "• Справочник инфраструктуры: магазины, аптеки, школы рядом с домом\n"
    "• /предложить — добавить место в справочник\n"
    "• FAQ и ответы на вопросы об услугах УК\n\n"
    "<b>Игры (зарабатывай монеты!)</b>\n"
    "• /21 — блэкджек (22:00–00:00)\n"
    "• /score — твой баланс и статистика\n"
    "• /21top — топ по монетам\n"
    "• /подарить — отправить монеты соседу (реплай на сообщение)\n\n"
    "<b>Трать монеты</b>\n"
    "• /магазин — каталог товаров за монеты\n"
...
- Проактивный режим: сам подсказываю, когда вижу, что могу помочь
- Запоминаю факты о жителях из разговоров (профили), чтобы давать персональные ответы
- Адаптирую тон под настроение чата
- Навигация по топикам: шлагбаум, ремонт, жалобы, барахолка, питомцы, мамы и папы, недвижимость
- /rules — правила сообщества

ИНФОРМАЦИЯ О ЖК:
- Справочник инфраструктуры: магазины, аптеки, школы рядом с домом
- /предложить — добавить новое место в справочник (формат: Название | Категория | Адрес)
...
- /подарить <количество> — подарить монеты соседу (реплай на его сообщение)
...
- /off_nudges — отключить персональные сообщения в личку
- /on_nudges — включить персональные сообщения в личку
