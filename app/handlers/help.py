...
MENTION_REPLIES = [
    "Жабот на посту! Проверяю, чтобы котики не получили бан по ошибке.",
    "Шлифую правила, полирую шлагбаум — Жабот всё контролирует!",
    "Считаю монеты, чтобы не убежали из банка. Жабот — надёжный казначей.",
    "Охочусь на флуд. Пока что флуд прячется от Жабота!",
    "Тестирую шутки. Эта прошла контроль качества Жабота.",
    "Слежу, чтобы объявления не убежали в оффтоп. Жабот бдит.",
    "Делаю вид, что отдыхаю. На самом деле Жабот модерирует.",
    "Полирую игровые карты. Блэкджек ждёт!",
    "Жабот проверяет, кто забыл сказать «доброе утро».",
    "Сканирую чат на предмет мемов. Всё стабильно.",
    "Отвечаю на упоминания. Это суперсила Жабота.",
    "Поднимаю щит модерации, но улыбаюсь по-жаботски.",
    "Жабот заботится, чтобы соседям было уютно, как в тапочках.",
    "Разгоняю пыль в чате, чтобы было чисто и весело.",
    "Взвешиваю монеты на улыбках — баланс идеален.",
    "Ищу потерянные мемы. Если найду — Жабот не отдаст.",
    "Дежурю у шлагбаума, но по совместительству комик.",
    "Контролирую очередность тем. Порядок — второе имя Жабота.",
    "Пишу заметки о хорошем настроении. Записал твоё.",
    "Разминаю алгоритмы, чтобы отвечать быстрее.",
    "Приглядываю за чатом, как жаба за болотом. Только болото — уютное.",
    "Строю мосты между темами, чтобы никто не потерялся.",
    "Жабот охраняет тишину в ночи, чтобы всем сладко спалось.",
    "Сортирую реплики по уровню улыбок. Ты в топе.",
    "Тренируюсь ставить мут одним взглядом. Жабот суров, но справедлив.",
    "Пересчитываю монеты. У кого-то их скоро будет больше, чем тараканов в подвале.",
    "Заряжаю банхаммер. На всякий случай. Жабот готов.",
    ...
    "Работаю. В отличие от тебя. Жабот всегда на связи.",
    "Объясняю шлагбауму, что не все водители читали ПДД. Он в шоке.",
    "Составляю чек-лист «как припарковаться на трёх местах сразу»",
    "Жабот проводит инвентаризацию хорошего настроения. Пока в плюсе!",
    "Настраиваю шестое чувство на обнаружение оффтопа.",
    "Перебираю темы форума — везде порядок, можно и чаю попить.",
    "Веду статистику: сколько раз за день кто-то написал «доброе утро». Ты уже?",
    "Слушаю тишину в чате. Подозрительно тихо. Что вы задумали?",
    "Обновляю внутренний рейтинг самых общительных соседей.",
    "Жабот проверяет прогноз погоды. Если дождь — Жабот счастлив, а вы берите зонтики!",
    "Пытаюсь разгадать, кто паркуется на двух местах сразу. Пока безуспешно.",
    "Перечитываю правила на случай, если кто-то решит их нарушить. Жабот готов!",
    "Мониторю двор через призму чата. Пока всё спокойно.",
    "Составляю ТОП-3 самых частых вопросов. Шлагбаум снова лидирует.",
    "Жду интересный вопрос. Может, твой?",
    "Готовлю вечернюю подборку новостей дома. Спойлер: шлагбаум работает.",
    "Наблюдаю за чатом с мудростью домового и скоростью Жабота.",
    "Протираю виртуальные очки, чтобы лучше видеть нарушителей.",
    "Жабот — не просто имя, это образ жизни. Квакаю по делу!",
    "Кто-то сказал «Жабот»? Я тут! Всегда тут.",
    "Сижу на кувшинке модерации, наблюдаю за течением чата.",
]
