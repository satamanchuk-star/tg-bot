...
AI_RATE_LIMIT_TEXT = "Подожди 20 секунд и спроси снова — я не успеваю за тобой!"

MENTION_REPLIES = [
    "Привет! Задай вопрос — постараюсь помочь.",
    "Тут! Если есть вопрос по ЖК — спрашивай.",
    "Слушаю! Чем могу помочь?",
    "На связи. Спрашивай — что знаю, расскажу.",
]
...
_CONTEXTUAL_REMARK_SYSTEM_PROMPT = (
    ...
    "Вставь короткую реплику по теме обсуждения — как сосед, который следит за разговором.\n\n"
    "ПРАВИЛА:\n"
    "- 1-2 предложения максимум.\n"
    "- Если можешь дать полезный совет по теме — дай.\n"
    "- Если обсуждение серьёзное — будь по делу, поддержи или предложи помощь.\n"
    "- Если тема бытовая — можно пошутить к месту.\n"
    "- НЕ отвечай на вопросы, которые не тебе адресованы.\n"
    "- Разговорный русский, 1 эмодзи допустим."
)
