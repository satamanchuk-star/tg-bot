...
# Вопрос не самодостаточен, только если ПРЯМО отсылает к медиа, которого у
# игрока нет. Слова «изображён/фото/рисунок» сами по себе не блокируют:
# ЧГК-вопросы описывают изображение словами, и ответить можно без картинки.
_MEDIA_MARKERS = (
    "см. картинку", "см. рисунок", "см. фото", "см. изображение",
    "по ссылке", "в видео", "на слайде", "прикреплён", "прикреплен",
    "ниже приведен", "ниже приведён",
)
